...
namespace frontend\modules\gzcz\controllers;
...
class ConnectController extends Controller{
    ...
    public function actionIndex(){
	    $callback = 'http://h5.thinkpower.top/gzcz/connect/callback';
	    ...
	    if(!isset($user->real_name) || $user->real_name == ''|| !isset($user->phone) || $user->phone == '')
            return $this->redirect(['/gzcz/connect/register']);

        return $this->redirect(['/gzcz/connect/rank']);	
    }
    ...
    public function actionFlash(){
        ...
        $identifier = Yii::$app->session->get('identifier');
        $callback = 'http://h5.thinkpower.top/gzcz/connect/flash-callback';
        if(!isset($identifier))
            return $this->redirect('https://open.weixin.qq.com/connect/oauth2/authorize?appid='.Yii::$app->params['appid'].'&redirect_uri='.$callback.'&response_type=code&scope=snsapi_userinfo');
    ...
    public function actionFlashCallback(){
        ...
        if(!isset($openid) || !isset($user)){
            ...
            if(isset($result['errorcode'])){
                return $this->redirect(['/gzcz/connect']);
            }
...
var_dump($info);exit;
    ...
    public function actionRegister(){
        ...
        return $this->renderFile('@frontend/modules/gzcz/views/connect/register.php',[
            'model' => $model,
    ...
    public function actionRank(){
        ...
        return $this->renderFile('@frontend/modules/gzcz/views/connect/rank.php',[
            'userInfo' => $userInfo,
            'rank' => $rank,
            'date' => $date,
            'dateList' => $dateList,
    ...
    public function actionPlay(){
        ...
        return $this->renderFile('@frontend/modules/gzcz/views/connect/play.php',[
            'identifier' => $identifier,
        ]);
    }
